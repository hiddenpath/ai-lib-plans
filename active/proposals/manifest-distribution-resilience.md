...
> 状态: accepted (Phase 1 complete 2026-06-17; Phase 2/3 deferred)
...
- **2026-06-17 — Phase 1（未知字段容忍）**：任务 **PT-077** 已完成。合规用例 `load-023`、fixture `mock-forward-compat-unknown-fields-v2.yaml`；Rust V1 `ProtocolManifest.extra` 与 V2 对齐；四运行时测试覆盖。Accept-Manifest 与 `_meta` 仍按上表延后。
