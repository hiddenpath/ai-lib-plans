...
| ZS-ML-007 | [tasks/ZS-ML-007-adapter-streaming-tool-completeness.yaml](./tasks/ZS-ML-007-adapter-streaming-tool-completeness.yaml) | `in_progress` | — | 整改阶段：补 Phase1（流式 `PartialToolCall`、多轮工具会话、流式集成测试）；branch pushed: `feat/zs-ml-007-stream-toolcall` / `73a050d` |
