...
| VL-EVO-002 | [tasks/VL-EVO-002-embed-prism-router.yaml](./tasks/VL-EVO-002-embed-prism-router.yaml) | `completed` ✅ | VL-EVO-001 | 内嵌 prism-core router — [PR #66](https://github.com/ailib-official/velaclaw/pull/66) (`a521ed2`) |
