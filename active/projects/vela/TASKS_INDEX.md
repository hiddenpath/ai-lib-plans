...
| ID | 文件 | 状态 | 依赖 | 说明 |
|----|------|------|------|------|
| PR-V2-001 | [tasks/PR-V2-001-model-comparison.yaml](./tasks/PR-V2-001-model-comparison.yaml) | `in_progress` ([PR #6](https://github.com/ailib-official/vela/pull/6)) | PR-V1-003 ✅ | 并排模型对比 UI |
