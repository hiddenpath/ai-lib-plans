...
| EOS-P2-006 | [tasks/EOS-P2-006-feature-enhancements.yaml](./tasks/EOS-P2-006-feature-enhancements.yaml) | `in_progress` | — | R3 ✅ #21；R4 ✅；R1 #22 权宜债务；R2 #23 stacked |
| EOS-P2-007 | [tasks/EOS-P2-007-document-capability-routing.yaml](./tasks/EOS-P2-007-document-capability-routing.yaml) | `planned` | ALR-DOC-001 ✅ | 退役 pdf_extract；Document block + 能力路由 |
...
| M11: Doc-route（EOS-P2-007） | Phase 2 Wave 5 | 📋 planned；ALR-DOC-001 ✅ 已解除上游阻塞 |
...
- `docs/EOS-P2-006-R4-WASM-FALLBACK-REVIEW.md` — R4 非 WASM fallback 决策（defer）
- `../../document-capability-routing.md` — 文档能力路由跨项目演进（2026-06-28）
- `docs/EOS-DOC-001-document-capability-routing.md` — 文档路由 ADR
