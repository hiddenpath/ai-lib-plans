...
| EOS-P2-006 | [tasks/EOS-P2-006-feature-enhancements.yaml](./tasks/EOS-P2-006-feature-enhancements.yaml) | `completed` | — | R3/R4 ✅；R1 ⏭ P2-007；R2 #24 |
...
| EOS-P2-008 | [tasks/EOS-P2-008-retire-document-attach.yaml](./tasks/EOS-P2-008-retire-document-attach.yaml) | `planned` | ALR-DOC-002 | 退役 P 层 document encode |
| EOS-REQ-P2-003 | — | `deferred` | PT-079 | 智能选模（Stage 4） |
